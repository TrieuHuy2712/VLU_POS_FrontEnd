...
export class OrderDetailComponent implements OnInit {
  ...
  public loadOrder(id: number) {
    if (this.currentPOS != 0) {
      this._dataService.get('/api/POS' + this.currentPOS + 'order/detail/' + id.toString()).subscribe((response: any) => {
  ...
  public loadOrderDetail(id: number) {
    if (this.currentPOS != 0) {
      this._dataService.get('/api/POS' + this.currentPOS + 'order/getalldetails/' + id.toString()).subscribe((response: any[]) => {
  ...
  public exportToExcel() {
    if (this.currentPOS != 0) {
      this._dataService.get('/api/POS' + this.currentPOS + 'order/exportExcel/' + this.orderId.toString()).subscribe((response: any) => {
